...
def generate_launch_description():
    default_config_locks = os.path.join(get_package_share_directory('tr_twist_mux'),
                                        'config', 'twist_mux_locks.yaml')
    default_config_topics = os.path.join(get_package_share_directory('tr_twist_mux'),
                                         'config', 'twist_mux_topics.yaml')
    default_config_joystick = os.path.join(get_package_share_directory('tr_twist_mux'),
    ...
    return LaunchDescription([
        ...
        Node(
            package='tr_twist_mux',
            executable='tr_twist_mux',
            output='screen',
